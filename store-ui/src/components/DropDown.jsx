...
export default function DropDown({ label, options, selectedValue, handleSort }) {
  return (
    <div className="flex items-center gap-2 justify-end pr-12 flex-1 font-primary">
      ...
      <select
        className="px-3 py-2 text-base border rounded-md transition border-primary focus:ring focus:ring-dark focus:outline-none text-gray-800 dark:text-lighter"
        value={selectedValue}
